...
| Session usage and titles | Local titles, text search, session totals, timestamps, sortable columns and 25/50/100-row pagination | Native paging/sorting and title overflow checks |
...
| Model catalog and prices | Offline JSON snapshot, editable rates, aliases and effective dates; searchable saved-price catalog with timestamp selection and historical entries | Native catalog search and save/reload/error verification |
