...
| Model catalog and prices | Offline JSON snapshot, editable rates, aliases and effective dates; searchable saved-price catalog with timestamp selection and historical entries; native search and valid/invalid save checked; inline structural/negative-rate errors verified with byte-identical file preservation | Native timestamp/history interaction |
