...
- First sandboxed GUI launch failed with access denied. Launch outside the tool sandbox succeeded as a normal user process and started its local worker. Desktop screenshot inspection could not proceed because Computer Use application approval timed out; visual/DPI acceptance remains pending.
