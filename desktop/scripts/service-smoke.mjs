...
await writeFile(join(source, 'session.jsonl'), [
  ...
  {timestamp:1800000000000,type:'event_msg',payload:{type:'token_count',info:{last_token_usage:{input_tokens:100,cached_input_tokens:80,output_tokens:20},total_token_usage:{input_tokens:100,cached_input_tokens:80,output_tokens:20}}}}
