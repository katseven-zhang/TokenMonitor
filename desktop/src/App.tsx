...
import { localInput,rangePreset,isRangePresetSelected,initialQuery,dateRange,windowOf } from './lib/range';
...
export default function App(){
 ...
 function quick(minutes:number){setQ({...q,...rangePreset(minutes)});}
